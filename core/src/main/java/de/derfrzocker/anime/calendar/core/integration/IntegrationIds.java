...
public final class IntegrationIds {
    ...
    public static final IntegrationId ANIDB = new IntegrationId(ANIDB_RAW);
    public static final String CRUNCHYROLL_RAW = "crunchyroll";
    public static final IntegrationId CRUNCHYROLL = new IntegrationId(CRUNCHYROLL_RAW);
    public static final String MY_ANIME_LIST_RAW = "myanimelist";
    public static final IntegrationId MY_ANIME_LIST = new IntegrationId(MY_ANIME_LIST_RAW);
    public static final String SYOBOI_RAW = "syoboi";
    public static final IntegrationId SYOBOI = new IntegrationId(SYOBOI_RAW);
