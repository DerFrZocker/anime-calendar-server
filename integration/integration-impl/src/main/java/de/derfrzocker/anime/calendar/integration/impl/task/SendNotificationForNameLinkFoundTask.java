...
import de.derfrzocker.anime.calendar.integration.impl.config.NameLinkFoundTaskConfig;
import de.derfrzocker.anime.calendar.integration.name.api.NameSearchResult;
import de.derfrzocker.anime.calendar.integration.name.event.PostNameLinkSearchEvent;
