...
import de.derfrzocker.anime.calendar.integration.name.event.PostAnimeNameHolderDeleteEvent;
import de.derfrzocker.anime.calendar.integration.name.event.PostAnimeNameHolderUpdateEvent;
import de.derfrzocker.anime.calendar.integration.name.event.PreAnimeNameHolderCreateEvent;
import de.derfrzocker.anime.calendar.integration.name.event.PreAnimeNameHolderDeleteEvent;
import de.derfrzocker.anime.calendar.integration.name.event.PreAnimeNameHolderUpdateEvent;
