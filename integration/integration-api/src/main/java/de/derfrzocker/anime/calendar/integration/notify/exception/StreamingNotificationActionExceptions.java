package de.derfrzocker.anime.calendar.integration.notify.exception;
...
public final class StreamingNotificationActionExceptions {

    private static final String RESOURCE_NAME = "StreamingNotificationAction";

    private StreamingNotificationActionExceptions() {
    }
