...
public record StreamingNotificationAction(
        ...
        int streamingEpisode,
        Instant streamingTime) implements ModificationInfo {
    ...
    public static StreamingNotificationAction from(
            NotificationActionId id,
            StreamingNotificationActionCreateData createData,
            RequestContext context) {
        return new StreamingNotificationAction(
                id,
                context.requestTime(),
                context.requestUser(),
                context.requestTime(),
    ...
    public StreamingNotificationAction updateWithData(
