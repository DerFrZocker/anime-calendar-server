...
public class NewAnimeTask {
    ...
    private void createNewAction(
            ...
            int episodeCount,
            RequestContext context) {
        NewAnimeNotificationActionCreateData createData = createData(
                result,
                fromIntegrationId,
    ...
    private NewAnimeNotificationActionCreateData createData(
            NameSearchResult result,
            IntegrationId fromIntegrationId,
            IntegrationAnimeId fromIntegrationAnimeId,
            int episodeCount) {
        ...
        return new NewAnimeNotificationActionCreateData(
    ...
    private void createNewManualAction(
            NotificationAction action,
            IntegrationId integrationId,
            IntegrationAnimeId integrationAnimeId,
            int episodeCount,
            RequestContext context) {
        NewAnimeNotificationActionCreateData manualActionCreateData = manualCreateData(
                integrationId,
                integrationAnimeId,
                episodeCount);
    ...
    private NewAnimeNotificationActionCreateData manualCreateData(
            IntegrationId integrationId,
            IntegrationAnimeId integrationAnimeId,
            int episodeCount) {
        return new NewAnimeNotificationActionCreateData(
