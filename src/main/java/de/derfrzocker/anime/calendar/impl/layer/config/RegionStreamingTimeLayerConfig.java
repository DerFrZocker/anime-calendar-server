...
public class RegionStreamingTimeLayerConfig extends BoundLayerConfig {
    ...
    public RegionStreamingTimeLayerConfig(int minInclusive, int maxInclusive, @NotNull String streamingService, @NotNull Set<@NotNull Region> applicableRegions, @NotNull String type, @NotNull Instant startTime, @NotNull Period period) {
