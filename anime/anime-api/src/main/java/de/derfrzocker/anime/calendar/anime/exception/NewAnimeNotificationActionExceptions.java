package de.derfrzocker.anime.calendar.anime.exception;
...
public final class NewAnimeNotificationActionExceptions {

    private static final String RESOURCE_NAME = "NewAnimeNotificationAction";
